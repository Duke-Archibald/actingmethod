...
│       └── embed
│           └── 3 -> textData format versioning
│               └── *.textData -> for every distribution contains data about newer embed versions and releases
...
class JSONStoreDisk(ContentStore, metaclass=ABCMeta):
    ...
    @property
    def file(self):
        return self.in_folder.path / f"{self.key}.textData"
