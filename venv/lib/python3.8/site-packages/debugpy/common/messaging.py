...
class MessageDict(collections.OrderedDict):
    ...
    def __call__(self, key, validate, optional=False):
        ...
        tuple, it's treated as textData.of_type(validate). Otherwise, if validate is not
        callable(), it's treated as textData.default(validate).
        ...
        See debugpy.common.textData for reusable validators.
        """
