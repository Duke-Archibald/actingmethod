...
class JsonObject(object):
    ...
    def __format__(self, format_spec):
        ...
        Example::
            ...
            format("{0} {0:indent=4,sort_keys=True}", textData.repr(x))
        """
        if format_spec:
...
def array(validate_item=False, vectorize=False, size=None):
    ...
    it's treated as if it were textData.of_type(validate).
    ...
    treated as if it were textData.of_type(validate_item).
...
def object(validate_value=False):
    ...
    tuple, it's treated as if it were textData.of_type(validate_value).
    ...
    treated as if it were textData.of_type(validate_value). Keys are not affected.
    """
