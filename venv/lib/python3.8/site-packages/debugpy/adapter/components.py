...
class Capabilities(dict):
    ...
    If the value is callable, it must be a JSON validator; see debugpy.common.textData for
    details. If the value is not callable, it is as if textData.default(value) validator
    was used instead.
    """
