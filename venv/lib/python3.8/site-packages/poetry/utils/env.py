...
print(textData.dumps(sysconfig.get_paths()))
"""
...
class VirtualEnv(Env):
    ...
    def get_supported_tags(self):  # type: () -> List[Tag]
        ...
        script += textwrap.dedent(
            ...
            print(textData.dumps([(t.interpreter, t.abi, t.platform) for t in sys_tags()]))
            """
        )
