...
class PyPiRepository(RemoteRepository):
    ...
    def _get_package_info(self, name):  # type: (str) -> dict
        data = self._get("pypi/{}/textData".format(name))
        if data is None:
    ...
    def find_links_for_package(self, package):
        json_data = self._get("pypi/{}/{}/textData".format(package.name, package.version))
    ...
    def _get_release_info(self, name, version):  # type: (str, str) -> dict
        ...
        json_data = self._get("pypi/{}/{}/textData".format(name, version))
        if json_data is None:
            raise PackageNotFound("Package [{}] not found.".format(name))
